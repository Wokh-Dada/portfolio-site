# cnt-flexy-view-abdullakh-header-presentation
...
| ------------ | --------- | -------------------------------------------------- | ----------------------------- | ----------- |
| `categories` | --        | объект с массивом меню и string для подкомпонентов | `AbdullakhHeaderPresentation` | `undefined` |
...
### Used by
 ...
 - [cnt-flexy-view-abdullakh-promo-header-wrapper-1_01](../../..)

### Depends on

- [cnt-flexy-view-abdullakh-promo-header-nav](./res/view/cnt-flexy-view-abdullakh-promo-header-nav)
- [cnt-flexy-view-abdullakh-promo-animate-btn](../../../../res/view/cnt-flexy-view-abdullakh-promo-animate-btn)
- [cnt-flexy-view-abdullakh-promo-about-me-section](./res/view/cnt-flexy-view-abdullakh-promo-about-me-section)
- [cnt-flexy-view-abdullakh-promo-header-social-icon](./res/view/cnt-flexy-view-abdullakh-promo-header-social-icon)
...
graph TD;
  ...
  style cnt-flexy-view-abdullakh-promo-header-presentation fill:#f9f,stroke:#333,stroke-width:4px
```
